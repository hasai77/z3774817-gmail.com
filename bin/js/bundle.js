(function () {
    ...
    var ui;
    (function (ui) {
        class lobbySceneUI extends Laya.Scene {
            constructor() { super(); }
            createChildren() {
    ...
    class LobbyScene extends ui.lobbySceneUI {
        constructor() {
            super();
            this.base = base.getinstance();
        }
        onAwake() {
            this.startGame.on(Event$1.CLICK, this, () => {
    ...
    class GameConfig {
        ...
        static init() {
            var reg = Laya.ClassUtils.regClass;
            reg("script/lobbyScene.ts", LobbyScene);
    ...
    GameConfig.startScene = "playScene.scene";
