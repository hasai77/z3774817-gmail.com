(function () {
    ...
    (function (ui) {
        ...
        class cowSceneUI extends Laya.Scene {
            constructor() { super(); }
            createChildren() {
                super.createChildren();
                this.loadScene("cowScene");
            }
        }
        ui.cowSceneUI = cowSceneUI;
        REG("ui.cowSceneUI", cowSceneUI);
        ...
        (function (Common) {
            ...
            (function (Game) {
                ...
                class UserUI extends Laya.View {
                    ...
                    createChildren() {
                        super.createChildren();
                        this.loadScene("Common/Game/User");
                    }
                }
                Game.UserUI = UserUI;
                REG("ui.Common.Game.UserUI", UserUI);
    ...
    class Hall extends ui.HallUI {
        ...
        onAwake() {
            ...
            this.market.on(Event.CLICK, this, this.onClickButton);
        }
        onClickButton() {
    ...
    class PublicFun {
        ...
        showAlert(node) {
            ...
            this.timeLine.on(Event$2.COMPLETE, this, this.onComplete);
            this.timeLine.on(Event$2.LABEL, this, this.onLabel);
        }
        hideAlert(node) {
            this.timeLine = new TimeLine();
            this.timeLine.addLabel("turnRight", 0).to(node, { scaleX: 1.1, scaleY: 1.1 }, 200, null, 0)
            ...
            this.timeLine.play(0, false);
            this.timeLine.on(Event$2.COMPLETE, this, () => {
                node.active = false;
                node.visible = false;
            });
        }
    ...
    class login extends ui.loginUI {
        ...
        onAwake() {
            ...
            this.login_change.on(Event$3.CLICK, this, this.changeHandler);
            this.chage_ok.on(Event$3.CLICK, this, function () {
                this.base.publicFun.hideAlert(this.loginAlert);
            });
            this.quikeStart.on(Event$3.CLICK, this, () => {
    ...
    class playScene extends ui.playSceneUI {
        ...
        onAwake() {
            ...
            this.fapai.clickHandler = new Handler$1(this, this.onClickButton, [this.fapai]);
            this.mopai.clickHandler = new Handler$1(this, this.onClickMopai, [this.mopai]);
            this.dapai.clickHandler = new Handler$1(this, this.onClickDapai, [this.dapai]);
        ...
        onClickDapai(button) {
            ...
            Tween$2.to(card13.transform, { localPositionZ: card13.transform.localPositionZ - 0.05, localRotationEulerY: 30 }, 300, null, Handler$1.create(this, () => {
                Tween$2.to(card13.transform, { localPositionX: card5.transform.localPositionX, localRotationEulerY: 0 }, 500, null, Handler$1.create(this, () => {
                    Tween$2.to(card13.transform, { localPositionZ: 0 }, 300);
                }));
            }));
        }
        onClickMopai(button) {
        ...
        onCreated() {
            ...
            scene.zOrder = -1;
            Laya.stage.on(Event$4.MOUSE_UP, this, this.sceneClick);
            this.init(scene);
        }
        sceneClick(e) {
            ...
            if (this._outHitResult.succeeded) {
                ...
                Tween$2.to(this.downHand[index].transform, { localPositionZ: clicked ? -0.00 : -0.015 }, 200, null, Handler$1.create(this, () => { }));
                this.downHand.forEach(element => {
                    if (element["index"] != index && element["clicked"]) {
                        Tween$2.to(element.transform, { localPositionZ: 0 }, 200, null, Handler$1.create(this, () => { }));
