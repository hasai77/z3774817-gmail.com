...
import CommonGameTypeSelection from "./CommonGameTypeSelection"
...
export default class CommonSelectiion extends ui.GameCommonUI.CommonSelectiionUI {
    constructor() {
        super()
    }
    onAwake() {
        (<CommonGameTypeSelection>this.items_view).setImages(images.RunFast, (e) => {
            console.log(e)
        })
    }
}