...
export default class User extends ui.GameCommonUI.Athletics.UserLeftUI {
    constructor() {
        super()
    }
    ...
    public get curtDealPos(){
        return this.propList.curDealPos;
    }
    public recvCard(number):void{
        //发牌接收
        this.propList.recvCard(number)
    }
    public showProp(list,how?):void{
        this.propList.propCard(list)
    }
    ...
    public showRush(number):void{
        let image = number;
        this.rush.texture =image; 
    }
